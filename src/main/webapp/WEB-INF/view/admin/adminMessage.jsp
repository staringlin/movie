    ...
    <div id="wrapper">
        ...
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/admin/pages/index.jsp">电影后台管理</a>
            </div>
            <!-- /.navbar-header -->
	    ...
	    <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/adminController/modifyAdmin" method="post"> 
	        ...
	        <div class="form-group">
	        	<label for="order_try_conunt" class="col-sm-2 control-label"> 密码</label> 
	            <div class="col-sm-10"> 
