	...
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-body"> 
				 <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/adminController/doAddMovie" method="post" enctype="multipart/form-data" id="upform"> 
				        <div class="form-group"> 
				            <label for="telephone" class="col-sm-2 control-label">电影图片</label> 
				            <div class="col-sm-10"> 
				                <input type="file" class="form-control1" id="myfile" name="myfile" > 
				            </div> 
				        </div> 
				        <div class="form-group">
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-10"> 
				                <input type="text" class="form-control1"  name="published_year" > 
				            </div> 
				        </div>				        				         				                 
				        <div class="form-group"> 
				            <div class="col-sm-offset-10 col-sm-2"> 
				                <input type="submit" class="btn btn-info btn-lg" value="添加" id="button">
				            </div> 
				        </div> 
				    </form> 
				    <div id="notice"></div>              
