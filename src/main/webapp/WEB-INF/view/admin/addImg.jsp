	...
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-body"> 
				 <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/adminController/addSlide" method="post" enctype="multipart/form-data" id="upform"> 
