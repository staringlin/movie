    ...
    <div id="wrapper">
        ...
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">修改用户</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="panel-body"> 
				 <form class="form-horizontal" role="form" action="/adminController/modifyUser" method="post"  > 
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-10"> 
				                <input type="text" class="form-control1"  name="username" value="${user.username}"> 
				            </div> 
				        </div> 
				        <div class="form-group">
				        	<label  class="col-sm-2 control-label">邮箱</label> 
				            <div class="col-sm-10"> 
				                <input type="text" class="form-control1"  name="email" value="${user.email}"> 
				            </div> 
				        </div>	
			   				   					   				        				        				                 
				        <div class="form-group"> 
				            <div class="col-sm-offset-10 col-sm-2"> 
				                <input type=submit class="btn btn-info btn-lg" value="修改" id="modify">
				                <a class="btn btn-info btn-lg" href="/adminController/getUsers">取消</a>
				            </div> 
				        </div> 
				    </form> 
