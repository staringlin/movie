	...
	<div id="wrapper">
					...
					<tbody>
						<c:forEach var="comment" items="${comments}" varStatus="status">
							...
							<tr>
								...
								<td><a href="${pageContext.request.contextPath}/adminController/deleteComment?id=${comment.id}&currentPage=${currentPage}" class="btn btn-info">删除</a></td>
							</tr>
						</c:forEach>
						...
						<tr id="message">
							<td></td>
							<td></td>
							<td colspan="3"><nav aria-label="Page navigation"
									class="pull-right ">
								<ul class="pagination pagination-lg" id="pageBtn">

								</ul>
								<span>共${pageCount}页</span> </nav></td>
		...
		<script type="text/javascript">
			$(function() {
				...
				var href = "/adminController/getComments?currentPage=";
				var item = "<li><a href='"
						+ href
						+ (dqPage - 1)
